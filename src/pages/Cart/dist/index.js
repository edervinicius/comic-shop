    ...
    var CartContent = function () {
        if (cartProd.length === 0) {
            ...
            return (react_1["default"].createElement(react_1["default"].Fragment, null,
                react_1["default"].createElement(styles_1.CartWrapper, null,
                    react_1["default"].createElement("tbody", null, cartProd.map(function (item, index) { return (react_1["default"].createElement("tr", { key: item.id },
